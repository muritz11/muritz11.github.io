          ...
          <div className="w-75-85 m-auto row">
            ...
            <div className="col-md-8 p-0">
              ...
              <p className="pt-4 pb-2 text-white-50" data-aos="fade-up">
                ...
                Typescript and React. I also dabble with PHP, MYSQL and Laravel.
                I craft awesome websites, landing pages and web apps, helping
                ...
                experience working with startups and managing product life
                cycles from development to production, driving growth and
                innovation.
                <br />
                <br />
          ...
          <div className="row">
            <div className="col-md-4 text-center serv" data-aos="zoom-in-up">
              ...
              <p className="text-white-50 service-text">
                ...
                applications using React, Typescript, and clean UI/UX
                principles. From landing pages to complex web apps, I craft
            ...
            <div className="col-md-4 text-center serv" data-aos="zoom-in-up">
              ...
              <p className="text-white-50 service-text">
                ...
                accessibility, and SEO. My approach balances technical
                efficiency with design, ensuring fast load times and strong
            ...
            <div className="col-md-4 text-center serv" data-aos="zoom-in-up">
              ...
              <p className="text-white-50 service-text">
                I help businesses deploy, manage, and maintain their
                websites/web apps — from shared hosting to cloud setups —
                ensuring reliability, security, and smooth operation.
              </p>
            </div>
          </div>
        </section>
